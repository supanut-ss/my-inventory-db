...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 7. Check existing count_detail line
        SELECT
        ...
        BEGIN
            ...
            SET quantity_count = @in_dec_quantity_count,
        ...
        ELSE
        BEGIN
            -- New line → get stock qty from actual inventory
            ...
            -- ✅ NEXT VALUE FOR แทน SCOPE_IDENTITY()
            SET @v_int_count_detail_id = NEXT VALUE FOR [inv].[SEQCountID];

            INSERT INTO [inv].[t_inv_count_detail] (
                count_detail_id,          -- ✅ ระบุ column + ค่าจาก sequence
                count_master_id,
                location_id, location,
                item_master_id, item_number, item_description,
                quantity_stock, quantity_count,
                item_uom_id, uom,
                inv_status, lot_number, expiry_date, serial_number,
                receive_date,
                count_by, count_date,
            ...
            VALUES (
                ...
                @in_int_location_id, @v_vch_location,
                @in_int_item_master_id, @v_vch_item_number, @v_vch_item_description,
                ISNULL(@v_dec_quantity_stock, 0), @in_dec_quantity_count,
                @in_int_item_uom_id, @v_vch_uom,
                @in_vch_inv_status, @in_vch_lot_number,
                @v_vch_expiry_date_str, @in_vch_serial_number,
                @v_dat_receive_date,
        ...
        ELSE
        BEGIN
            -- ✅ count_reconcile_id มี default sequence → ไม่ต้อง NEXT VALUE FOR
