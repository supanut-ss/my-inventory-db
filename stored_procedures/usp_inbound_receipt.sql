USE [MyInventory]
GO
/****** Object:  StoredProcedure [inv].[usp_inbound_receipt]    Script Date: 8/6/2569 13:40:08 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    DECLARE
        ...
        @v_dec_rem_plan_qty           DECIMAL(18, 5),
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            WHERE warehouse_id  = @v_int_warehouse_id
              ...
              AND ISNULL(receive_date, '')          = ISNULL(CAST(GETDATE() AS DATE), '');
